...
import { getTokenMetadata } from "@/server/actions/tokens"
  ...
  try {
    if (mint) {
      ...
      return NextResponse.json(tokens, {
        status: 200,
        headers: { "Cache-Control": "public, max-age=3600, stale-while-revalidate=86400" }, // Cache for 1 hour, revalidate after 24 hours
      })
    }
  } catch (err: any) {
